...
2. **Review changes** — run `git diff --stat` (unstaged) and `git diff --cached --stat` (staged) to understand what changed. Briefly summarize the categories of changes (e.g. "3 L2 files updated, 1 new L4 report, 2 agent configs modified").
