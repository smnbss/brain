...
The user MAY provide a Linear project URL, e.g.:
```
https://linear.app/weroad/project/super-edc40903e247/overview
```
...
- Examples:
  - `https://linear.app/weroad/project/super-edc40903e247/overview` → `super-edc40903e247`
  - `https://linear.app/weroad/project/super-edc40903e247/issues` → `super-edc40903e247`
